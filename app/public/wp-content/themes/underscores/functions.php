...
/**********************************/
// OVERWRITE STYLE.CSS WITH MAIN.CSS 
/**********************************/

function new_style() {
	wp_enqueue_style('newtheme-style', get_stylesheet_uri());
	wp_enqueue_style('main', get_template_directory_uri().'/css/main.css'); wp_enqueue_style('main', get_template_directory_uri().'/css/main.css', array('theme-style'));
	}

	add_action('wp_enqueue_scripts', 'new_style');